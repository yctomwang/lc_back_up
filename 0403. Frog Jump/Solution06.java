...
Submission Detail:{
    ...
    Ranking : 
        ...
        Your memory usage beats 25.72 % of java submissions.
}
*/
...
class Solution {
    ...
    private boolean dfs(int pos, int target, int lastjump){
        ...
        if(validSet.contains(pos+lastjump+1)&&lastjump+1!=0){
//             System.out.print(lastjump+1);
//             System.out.print(validSet.contains(pos+lastjump+1));
//             System.out.println(pos+lastjump+1);
        ...
        // System.out.println(optThree+"____");
        
        //boolean optTwo = dfs(pos+lastjump, target, lastjump);
        //boolean optThree = dfs(pos+lastjump,target,lastjump+1);
